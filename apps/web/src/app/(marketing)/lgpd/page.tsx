...
export const metadata = {
  title: 'LGPD',
  description: 'Como o ZapAI cumpre a Lei Geral de Proteção de Dados. DPO, direitos do titular, endpoints práticos.',
};
  ...
  return (
    ...
    >
      <p className="text-lg leading-relaxed text-muted-foreground">
        Esta página explica em <LegalDt>linguagem direta</LegalDt> como o ZapAI cumpre a Lei
      ...
      <div className="mt-16 space-y-2">
        ...
        <LegalSection id="controlador-operador" number={2} title="Controlador x operador">
          ...
          <LegalList>
            <li>
              Em relação a <LegalDt>dados de Clientes do ZapAI</LegalDt> (você, dono da conta) —
        ...
        <LegalSection id="endpoints" number={5} title="Endpoints LGPD">
          <p>Pra Clientes do ZapAI que querem automatizar atendimento ao titular:</p>
          ...
          <p>
            ...
            <Link href="/blog/api-publica-zapai" className="text-foreground underline-offset-4 hover:underline">
              docs da API
            </Link>
            .
          </p>
        ...
        <LegalSection id="dpa" number={7} title="DPA — Data Processing Agreement">
          <p>
            ...
            de dados de seus titulares conosco (com o ZapAI atuando como operador), oferecemos um
