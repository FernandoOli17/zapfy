...
export function OnboardingChecklist({ progress }: { progress: OnboardingProgress }) {
  ...
  return (
    <section id="onboarding-checklist" className="animate-slide-up overflow-hidden rounded-2xl border border-primary/30 bg-gradient-to-br from-primary/10 via-card to-card p-5 md:p-6">
